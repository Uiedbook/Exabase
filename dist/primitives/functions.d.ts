...
export declare function deleteMessage(_id: string, dir: string, _unique_field: Record<string, true> | undefined, RCT_KEY: string, fn: string): Promise<Msg>;
...
export declare const updateIndex: (fileName: string, _unique_field: Record<string, true>, message: Msg) => Promise<void>;
export declare const findIndex: (fileName: string, _unique_field: Record<string, true>, data: Record<string, any>) => Promise<false | string[]>;
...
export declare const dropIndex: (fileName: string, data: Record<string, any>, _unique_field: Record<string, true>) => Promise<void>;
