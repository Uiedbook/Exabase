...
export declare function deleteMessage(_id: string, dir: string, _unique_field: Record<string, true> | undefined, _foreign_field: boolean, fn: string, RCTiedlog: any): Promise<any>;
...
export declare const binarysorted_insert: (message: Msg, fn: string, RCTiedlog: Msgs) => Promise<Msgs>;
...
export declare function Twritter(filename: string, data: Buffer): Promise<void>;
